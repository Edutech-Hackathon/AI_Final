...
GRADE_LEVELS = {
    ...
    '중학교 1학년': {
        'difficulty': 'medium',
        'topics': ['정수와 유리수', '문자와 식', '일차방정식', '좌표평면', '통계']
    },
    '중학교 2학년': {
        'difficulty': 'medium',
        'topics': ['유리수와 순환소수', '식의 계산', '연립방정식', '일차함수', '확률']
    },
    '중학교 3학년': {
        'difficulty': 'medium-hard',
        'topics': ['제곱근과 실수', '인수분해', '이차방정식', '이차함수', '삼각비']
    },
    '고등학교 1학년': {
        'difficulty': 'hard',
        'topics': ['집합과 명제', '함수', '지수와 로그', '삼각함수', '수열']
    },
    '고등학교 2학년': {
        'difficulty': 'hard',
        'topics': ['극한', '미분', '적분', '확률과 통계', '기하']
    },
    '고등학교 3학년': {
        'difficulty': 'very-hard',
        'topics': ['미적분', '확률과 통계', '기하와 벡터', '수능 대비']
    }
}
